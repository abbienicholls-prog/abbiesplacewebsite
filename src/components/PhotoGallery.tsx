...
const PhotoGallery = () => {
  ...
  const thumbStart = Math.floor(currentIndex / thumbnailsPerPage) * thumbnailsPerPage;
  const visibleThumbs = photos.slice(thumbStart, thumbStart + thumbnailsPerPage);
